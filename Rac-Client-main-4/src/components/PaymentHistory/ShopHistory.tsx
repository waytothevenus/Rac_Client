...
const ShopHistoryData = [
  ...
  {
    ImportantNotice0:
      "You are covered for your full declared value of $65.00 only in case of total l" +
      "oss or damage",
  },
  {
    ShippingCost: "$126.66",
  ...
  {
    ImportantNotice2:
      "We do not ship or return any fraudulent purchased items. You are advised to on" +
...
const ShopHistory = () => {
  return (
    <div className="font-robot">
      <div className="flex max-w-[1000px] flex-col gap-[20px] rounded-[20px] bg-white p-[20px] md:p-[30px]">
        <div className="flex items-center rounded-[20px] border-2 border-dashed border-[#6750A4] p-[20px] max-sm:flex-col ">
        ...
        <div className="flex items-center justify-center rounded-[20px] border-2 border-solid border-[#CAC4D0] p-[10px] max-sm:flex-col ">
          <div className="flex">
            <div className="text-[28px] text-[#1C1B1F] max-sm:text-[22px]">
              Request ID:
            </div>
            <div className="text-[28px] font-[700] text-[#1C1B1F] max-sm:text-[22px]">
              {ShopHistoryData[0]?.RequestID}
            </div>
          </div>
          ...
          <div className="flex items-center max-sm:mt-[20px]">
            <div className="flex items-center pe-[10px] ps-[30px] text-[22px] text-[#1C1B1F] max-sm:ps-0">
              Unpaid
            </div>
            <button className="btn relative flex h-[40px] w-[122px] items-center justify-center gap-x-2 rounded-[6.25rem] bg-[#B3261E] px-4 py-2.5 text-sm font-medium tracking-[.00714em] text-white md:ps-1">
              <img src="/images/icon.svg"></img>
              <div className="text-[14px] font-[500] text-white">Pay Now</div>
            </button>
          </div>
          ...
          <div className="flex flex-col justify-center">
            <div className="flex">
              ...
              <div className="flex flex-col">
                ...
                <div className="text-[22px]">
                  {ShopHistoryData[1]?.CreatedData}
                </div>
                <div className="text-[22px]">
                  {ShopHistoryData[1]?.CreatedTime}
                </div>
              </div>
            </div>
        ...
        <div className="mt-[10px] flex justify-between max-sm:flex-col">
          <div className="flex h-[173px] w-[267.5px] flex-col justify-end max-sm:h-[161px] max-sm:w-full">
            <div className="text-[22px]">Invoiced To</div>
            <div className="flex flex-row text-[16px]">
              <div className="font-[500]">
                {ShopHistoryData[2]?.BuyerUserName}-
              </div>
              <div className="font-[700]">{ShopHistoryData[2]?.BuyerName}</div>
            </div>
            <div className="text-[16px]">{ShopHistoryData[2]?.BuyerPhone}</div>
            <div className="text-16px]">{ShopHistoryData[2]?.BuyerEmail}</div>
            <div className="text-[16px]">
              {ShopHistoryData[2]?.BuyerCity},<br></br>
              {ShopHistoryData[2]?.BuyerCountry}
            </div>
          </div>
          ...
          <div className="flex h-[173px] w-[267.5px] flex-col max-sm:my-[20px] max-sm:w-full max-sm:items-end">
            {/* // w-[345px] */}
            <div className="text-[22px]">Pay To</div>
            <div className="flex flex-row text-[16px] font-[500]">
              {ShopHistoryData[4]?.SellerName}
            </div>
            <div className="text-[16px]">
              {ShopHistoryData[4]?.SellererPhone}
            </div>
            <div className="text-16px]">{ShopHistoryData[4]?.SellerEmail}</div>
            <div className="flex text-[16px] max-sm:text-right">
              {ShopHistoryData[4]?.SellerCity},<br></br>
              {ShopHistoryData[4]?.SellerCountry}
            </div>
          </div>

          <div className="h-[173px] w-[345px] rounded-[20px] border bg-[#CAC4D0] px-[14px] py-[10px] max-sm:w-full">
            {/* className="w-full rounded-[20px] border bg-[#CAC4D0] px-[14px] py-[10px]" */}
            <div className="mb-[20px] ps-[14px] text-[22px] text-[#21005D]">
              IMPORTANT NOTICE:
            </div>
            <div className="ps-[14px] text-[16px] text-[#49454F]">
              {ShopHistoryData[5]?.ImportantNotice0}
        ...
        <div>
          ...
          <div className="w-[940px] rounded-[20px] border border-solid border-[#CAC4D0] max-sm:w-full">
            <div className="mb-[10px] ms-[20px] mt-[6px] flex items-center max-sm:ms-[10px]">
              <div className="flex h-[40px] w-[40px] items-center justify-center">
                <input type="radio" className="opacity-0.38 h-4 w-4"></input>
              </div>
              <p className="text-[14px] font-[500]">Basic</p>
            </div>
            <div className="mb-[10px] flex ps-[50px] text-[14px] font-[500] max-sm:ps-[25px]">
            ...
            <div className="mb-[10px] flex ps-[50px] text-[14px] max-sm:ps-[25px]">
              ...
              can call us on +234 700 700 6000 or +1 888 567 8765 or send us a
              dm to get alternative shipping methods with different benefits.
            </div>
            <div className="mb-[14px] flex ps-[50px] text-[14px] max-sm:ps-[25px]">
              The cost paid here covers clearing, documentation and delivery to
              the destination.
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="w-[940px] rounded-[20px] border border-solid border-[#CAC4D0] max-sm:w-full">
            <div className="ml-[10px] mr-[20px] flex items-center justify-between">
            ...
            <div className="mb-[14px] flex ps-[40px] text-[14px] max-sm:ps-[25px]">
        ...
        <div className="flex w-full flex-1 justify-between gap-[20px] max-sm:flex-col-reverse">
          <div className="flex flex-col">
            ...
            <div className="mt-[5px] w-full flex-1 rounded-[20px] border bg-[#F2B8B5] px-[14px] py-[10px] max-sm:h-auto max-sm:w-full">
              <div className="mb-[20px] ps-[14px] text-[22px] text-[#21005D]">
                IMPORTANT NOTICE:
              </div>
              <div className="px-[14px] text-[14px] text-[#49454F]">
                {ShopHistoryData[7]?.ImportantNotice2}
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-[5px] w-[725px] rounded-[20px] border bg-white pb-[15px] text-[14px] font-[500]">
              <div className="flex items-center justify-between rounded-t-[20px] border bg-[#F4EFF4] px-[30px] py-[20px] ">
              ...
              <>
                {ItemData.map((item) => {
                  return (
                    <div className="mx-[30px] my-[20px] flex items-center justify-between border-b bg-white pb-[20px]">
                      <div className="w-[200px]">
                        <img src={`/images/${item?.ItemSrc}.svg`}></img>
                        <div>{item?.Item}</div>
                      </div>
                      <div className="flex w-[150px]">{item?.ItemUrl}</div>
              ...
              <div className="flex items-center justify-between bg-[#FFFBFE] px-[30px] pt-[10px]">
              ...
              <div className="flex items-center justify-between bg-white px-[30px] py-[5px] text-[22px]">
                <div className="w-[215px]">
                  {ShopHistoryData[8]?.TotalNumber}
                </div>
                <div className="w-[215px]">
                  {ShopHistoryData[8]?.TotalWeight}
                </div>
                <div className="w-[215px]">{ShopHistoryData[8]?.TotalCost}</div>
              </div>
              ...
              <div className="flex items-center justify-between bg-white px-[30px] py-[5px] text-[22px]">
                <div className="w-[215px]">
                  {ShopHistoryData[8]?.ProcessingFee}
                </div>
                <div className="w-[215px]">
                  {ShopHistoryData[8]?.PurchaseFee}
                </div>
                <div className="w-[215px]">
                  {ShopHistoryData[8]?.TotalMeCost}
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="rounded-[20px] border bg-[#21005D] px-[14px] py-[10px] text-[14px] font-[500] text-white">
            <div className="mx-[14px] mb-[10px] flex items-center justify-between py-[10px] text-[22px]">
              Order Costs Summary
            </div>
            ...
            <>
              {OrderItem1.map((item) => {
                return (
                  <div className="mx-[14px] flex items-center justify-between border-b py-[10px]">
                    <div>{item[0]}</div>
                    <div>
                      {item[0] != "Discount:" ? (
                        <div>${item[1]}</div>
            ...
            <div className="mx-[14px] my-[5px] flex items-center justify-between pt-[10px]">
              Total:
            </div>
            <div className="mx-[14px] mb-[5px] flex items-center justify-between text-[22px]">
              $126.66
            </div>
        ...
        <div className="py-[5px]">
          <div className="flex items-center px-[20px] py-[2px]">
            <img src="/images/arrow-right.svg"></img>
            <div className="ms-[10px]">
              Our current exchange rate which is subjected to change according
              to market trends is ($1=₦1,200), you will be charged the Naira
              Equivalent of the shipping cost based on the current exchange rate
              at any given time/point of payment
            </div>
          </div>
          <div className="flex items-center px-[20px] py-[2px]">
        ...
        <div className="flex justify-center">
          <button className="btn relative flex h-[40px] w-[410px] items-center justify-center gap-x-2 rounded-[6.25rem] bg-[#B3261E] px-4 py-2.5 text-sm font-medium tracking-[.00714em] text-white md:ps-1">
            <img src="/images/icon.svg"></img>
        ...
        <div className="mt-[20px] flex justify-center">
          <button className="btn relative mx-[5px] flex h-[40px] w-[205px] items-center justify-center gap-x-2 rounded-[6.25rem] border-[1px] border-solid bg-white px-4 py-2.5 text-sm font-medium tracking-[.00714em] text-white md:ps-1">
            <img src="/images/printer.svg"></img>
            <div className="font-robot text-[14px] font-[500] text-[#6750A4]">
              Print
            </div>
          </button>
          <button className="btn relative mx-[5px] flex h-[40px] w-[205px] items-center justify-center gap-x-2 rounded-[6.25rem] bg-[#6750A4] px-4 py-2.5 text-sm font-medium tracking-[.00714em] text-white md:ps-1">
            <img src="/images/receive-square.svg"></img>
            <div className="font-robot text-[14px] font-[500] text-white">
              Download
            </div>
          </button>
        </div>
