    ...
    <>
      <div className="flex flex-col gap-[20px]">
        <div className="flex">
          ...
          <div className="flex min-w-[125px] flex-row items-center justify-center gap-[12px] rounded-[10px] border-[0.5px] border-[#B3261E] border-opacity-30 px-3 py-[10px] font-[400]">
            <div className="text-[22px] text-[#B3261E]">
              {onShipments.length}
            </div>
            <div className="text-[12px] tracking-[.4px] text-[#625B71]">
              Ongoing Shipments
            </div>
          </div>
        </div>
        <div className="flex">
          <button className="prev-button flex h-[24px] w-[18px] rounded-[20px] text-[#79747E]">
            {<ArrowLeft />}
          </button>
          <button className="next-button ml-[auto] mr-0 flex h-[24px] w-[18px] rounded-[20px] text-[#79747E]">
            {<ArrowRight />}
          </button>
        </div>
      </div>
      ...
      >
        {onShipments.map((item) => (
          <SwiperSlide key={item._id}>
            <div className="flex gap-[20px] rounded-[20px] bg-white">
              <div className="flex max-w-[293.33px] flex-col gap-[10px]">
                <div className="gap-[30px]">
                  <div className="flex">
                    <div className="flex items-center gap-[8px]">
                      <div className="flex min-w-[290.67px] flex-row items-center justify-center gap-[12px] rounded-[10px] border-[0.5px] border-[#B3261E] border-opacity-50 px-[10px] py-[3px] text-[14px] font-[400] text-[#79747E]">
                        <span className="w-fulltracking-[.25px] flex text-[14px]">
                          Tracking ID:
                        </span>
                        <span className="flex h-[10px] border-[.5px]"></span>
                        <span className="text-[12px] font-[500] tracking-[.5px]">
                          {item.trackingId}
                        </span>
                      </div>
                    </div>
                ...
                <div className="gap-[30px]">
                  <div className="grid grid-cols-2 items-center gap-[4px]">
                    <div className="flex max-w-[143.33px] flex-row items-center justify-end gap-[12px] rounded-bl-[10px] rounded-tl-[10px] rounded-tr-[10px] border-[0.5px] border-[#21BCAA] border-opacity-50 px-[10px] py-[3px] text-[14px] font-[400] text-[#79747E]">
                      <span className="flex text-[14px] tracking-[.25px]">
                        Order ID:
                      </span>
                    </div>
                    <div className="flex max-w-[143.33px] flex-row items-center justify-start gap-[12px] rounded-bl-[10px] rounded-br-[10px] rounded-tr-[10px] border-[0.5px] border-[#21BCAA] border-opacity-50 bg-[#21BCAA] px-[10px] py-[3px] text-[14px] font-[400] text-[#FFFFFF]">
                      <span className="flex text-[14px] tracking-[.25px]">
                        {item.orderId}{" "}
                      </span>
                    </div>
                ...
                <div className="gap-[30px]">
                  <div className="grid grid-cols-2 items-center gap-[4px]">
                    <div className="flex w-[143.33px] flex-row items-center justify-end gap-[12px] rounded-bl-[10px] rounded-tl-[10px] rounded-tr-[10px] border-[0.5px] border-[#21005D] border-opacity-50 px-[10px] py-[3px] text-[14px] font-[400] text-[#79747E]">
                      <span className="flex text-[14px] tracking-[.25px] text-[#21005D]">
                        Shipping status:
                      </span>
                    </div>
                    <div className="flex w-[143.33px] flex-row items-center justify-start gap-[12px] rounded-bl-[10px] rounded-br-[10px] rounded-tr-[10px] border-[0.5px] border-[#21005D] border-opacity-50 bg-[#21005D] px-[10px] py-[3px] text-[14px] font-[400] text-[#FFFFFF]">
                      <span className="flex text-[14px] tracking-[.25px]">
                        In transit
                      </span>
                    </div>
                ...
                <div className="flex h-[180px] rounded-[20px] bg-primary-900 px-[20px] py-[10px] text-white">
                  ...
                  <div className="flex flex-col">
                    ...
                    >
                      <path
                        d="M122.726 39.4678C122.726 39.4678 118.438 47.5566 122.726 52.3469C136.126 67.3166 190.276 52.3469 235.309 52.3469"
                        stroke="#625B71"
                        strokeWidth="2"
                      />
                      <ellipse
                      ...
                      />
                      <path
                        d="M16.0312 17.6199C60.6015 17.62 115.111 2.72507 128.59 17.6199C132.932 22.4183 128.59 30.5287 128.59 30.5287"
                        stroke="white"
                        strokeWidth="2"
                      />
                    </svg>
                    ...
                    <div className="flex flex-col gap-[1px] self-end pr-[10px]">
                      <span className="title-md self-end font-bold">
                        Destination:
                      </span>
                ...
                <div className="flex flex-col">
                  <h3 className="text-[14px] font-[500] tracking-[.1px]">
                    Most Recent Update
                  </h3>
                  <h2 className="pb-[5px] text-[16px] font-[500] tracking-[.1px] text-[#49454F]">
                    Processed at London - Heathrow - UK
                  </h2>
                  <span className="border-b border-dashed pb-[13px]">
                ...
                <div className="flex flex-col items-center justify-center pb-[20px]">
                  <img
                    src="images/Rectangle 9130.png"
                    className="rounded-[10px]"
                  />
                  <button className="-mt-[50px] flex w-[242px] flex-row items-center justify-center gap-[12px] rounded-[10px] border-[0.5px] border-[#21005D] border-opacity-50 bg-white px-[10px] py-[3px] text-[14px] font-[500] leading-[20px] text-[#79747E]">
                    <svg
                      width="19"
                      height="18"
                      viewBox="0 0 19 18"
